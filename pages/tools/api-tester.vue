    ...
    <div class="min-h-screen bg-gray-50 dark:bg-gray-900   ">
        ...
        <div class="container mx-auto px-6 py-8 grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div class="bg-blue-50 dark:bg-gray-800 rounded-3xl p-8 md:max-h-[70vh]">
                <div class="mb-2">
                    <span
                        class="bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 text-sm px-4 py-1 rounded-full">
                ...
                <p class="text-gray-600 dark:text-gray-300 mb-12 text-lg">
                    Streamline your API testing process with powerful and intuitive tool. Debug, validate, and optimize
                    your endpoints with ease.
                </p>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="flex items-start space-x-4">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-500 dark:text-gray-400">Support for GET, POST, PUT, DELETE,
                                    and PATCH requests.</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start space-x-4">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-500 dark:text-gray-400">Instantly send requests and view
                                    responses.</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start space-x-4">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-500 dark:text-gray-400">Syntax-highlighted JSON response and
                                    headers display.</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start space-x-4">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-500 dark:text-gray-400">Intuitive design for effortless API
                                    testing.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="space-y-4">
                        <div class="flex gap-4">
                            ...
                            <Menu as="div" class="relative">
                                <MenuButton
                                    class=" flex items-center justify-center px-4 py-2 text-left dark:text-white bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-600">
                                    <Icon icon="fe:arrow-down" class="w-5 h-5" />
                                    {{ method }}
                                </MenuButton>
                                <transition enter-active-class="transition duration-100 ease-out"
                                    ...
                                    <MenuItems
                                        class="absolute z-10 mt-2 w-28 rounded-lg bg-white dark:bg-gray-700 dark:text-white shadow-lg border border-gray-200 dark:border-gray-600">
                                        <div class="py-1">
                                            <MenuItem v-for="m in methods" :key="m" v-slot="{ active }">
                                            <button @click="method = m" :class="[
                            ...
                            <!-- URL Input -->
                            <input v-model="url" type="text" placeholder="Enter API URL"
                    ...
                    <div class="p-6">
                        ...
                        <div class="border-b border-gray-200 dark:border-gray-700 mb-4">
                            <div class="flex space-x-8">
                                <button v-for="tab in ['Response', 'Headers']" :key="tab" @click="activeTab = tab"
                                    :class="[
                        ...
                        <div class="min-h-[200px]">
                            ...
                            <div v-else>
                                <div v-if="activeTab === 'Response'" class="font-mono text-sm">
                                    <pre
                                        class="whitespace-pre-wrap text-gray-800 dark:text-gray-200 overflow-x-auto">{{ JSON.stringify(response?.body, null, 2) }}</pre>
                                </div>
